...
# launch programs
COMMANDS["Apps"]="rofi -modi drun,run -show-icons -show"
LABELS["Apps"]=""

#use ytfzf -D method
COMMANDS["Watch"]="~/.config/rofi/scripts/ytube.sh"
LABELS["Watch"]=""

# power
COMMANDS["Power"]="~/.config/rofi/scripts/power.sh"
LABELS["Power"]=""

# search local files
COMMANDS["Locate"]="~/.config/rofi/scripts/rofi-locate.sh"
LABELS["Locate"]=""

# open custom web searches
COMMANDS["Websearch"]="~/.config/rofi/scripts/rofi-surfraw-websearch.sh"
LABELS["Websearch"]=""

#ytfzf or search youtube easily and mpv thingy... set later
...
function start()
{
    ...
    print_menu | sort | rofi -show -modi drun -dmenu -mesg ">>> Launch scripts" -i -p "Search"
